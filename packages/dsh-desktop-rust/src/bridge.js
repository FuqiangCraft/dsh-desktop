(() => {
  ...
  const installTitlebar = () => {
    ...
    style.textContent = '#dsh-shell-titlebar{height:36px;position:fixed;inset:0 0 auto;z-index:2147483647;display:flex;align-items:center;background:#f3f6fa;color:#59636e;font:13px system-ui,sans-serif;user-select:none;border-bottom:1px solid rgba(36,48,61,.08)}#dsh-shell-titlebar button{height:100%;border:0;background:transparent;color:inherit;font:inherit;cursor:pointer;-webkit-app-region:no-drag}#dsh-shell-titlebar button:hover{background:#e4eaf0;color:#28323c}#dsh-shell-titlebar nav{display:flex;height:100%;margin-left:4px;-webkit-app-region:no-drag}#dsh-shell-titlebar nav button{padding:0 10px}#dsh-shell-titlebar .dsh-shell-sidebar{width:42px;display:flex;align-items:center;justify-content:center}#dsh-shell-titlebar .dsh-shell-sidebar svg{width:16px;height:16px;fill:none;stroke:currentColor;stroke-width:1.25}#dsh-shell-titlebar .dsh-shell-history{width:30px;padding:0;font-size:24px;font-weight:300;line-height:1}#dsh-shell-titlebar .dsh-shell-drag{height:100%;flex:1;-webkit-app-region:drag}#dsh-shell-titlebar .dsh-shell-controls{height:100%;display:flex;margin-left:auto;-webkit-app-region:no-drag}#dsh-shell-titlebar .dsh-shell-controls button{width:46px;padding:0;font-size:16px}#dsh-shell-titlebar .dsh-shell-controls button[data-window=close]:hover{background:#c42b1c;color:#fff}html{padding-top:36px!important;box-sizing:border-box!important}body{margin-top:0!important}'
